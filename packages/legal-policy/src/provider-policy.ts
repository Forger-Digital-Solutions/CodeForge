...
export const PROVIDER_POLICY_REGISTRY: ProviderPolicyRecord[] = [
  ...
  // --- Mistral ------------------------------------------------------------------------------
  {
    ...
    regionUnknownBehavior: "ALLOW",
    confidentialDataPolicy: "AVOID_SUBMISSION_RECOMMENDED",
    providerDataUse: ["TRAINING_POSSIBLE"],
    hostedResaleStatus: "ALLOWED",
    qualificationTrafficStatus: "RATE_LIMITED",
    attorneyReviewStatus: "NONE",
    authoritySource: "Mistral commercial terms; Mistral Admin Limits and Subscriptions documentation (current account free-mode allowance)",
    reviewedAt: REVIEWED_AT,
    expiresAt: EXPIRES_AT,
    enforcement: "ALLOW",
    reasonCode: "MISTRAL_FREE_ALLOWANCE_ACCOUNT_ATTESTATION",
    notes: "Free-mode eligibility is account-dependent and must be attested before ForgeAuto/Free routing; live production model discovery remains authoritative.",
  },
  ...
  // --- Cerebras -----------------------------------------------------------------------------
  {
    ...
    attorneyReviewStatus: "NONE",
    authoritySource: "Cerebras Inference rate-limits documentation and Cerebras Terms of Service",
    reviewedAt: REVIEWED_AT,
    expiresAt: EXPIRES_AT,
    enforcement: "DENY",
    reasonCode: "CEREBRAS_PROMOTIONAL_CREDIT_NOT_FREE_ROUTING",
    notes: "The documented offer is time-boxed promotional credit, not a recurring zero-cash entitlement; it is excluded from ForgeAuto/Free.",
  },
  {
    providerId: "cerebras",
    architecture: "BYOK",
    ...
    qualificationTrafficStatus: "PERMITTED",
    attorneyReviewStatus: "NONE",
    authoritySource: "Cerebras Terms of Service and Inference API documentation",
    reviewedAt: REVIEWED_AT,
    expiresAt: EXPIRES_AT,
    enforcement: "ALLOW",
    reasonCode: "CEREBRAS_BYOK_PAID_OR_TRIAL_ONLY",
    notes: "This record permits explicit BYOK use only; it does not make promotional credits eligible for Managed-Free routing.",
  },
