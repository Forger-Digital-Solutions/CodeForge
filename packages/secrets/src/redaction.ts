...
const SECRET_PATTERNS: Array<{ re: RegExp; type: string }> = [
  ...
  { re: /CLOUDFLARE_API_TOKEN\s*[:=]\s*['"]?[^'"\s]+/gi, type: "cloudflare_token" },
  ...
  { re: /\bsk-[A-Za-z0-9\-_]{10,}/g, type: "sk_key" },
  { re: /\bsk-proj-[A-Za-z0-9\-_]{10,}/g, type: "openai_proj" },
  { re: /\bgsk_[A-Za-z0-9]{10,}/g, type: "groq_key" },
  ...
  { re: /private\s*key\s*[:=]\s*['"]?[^'"\s]+/gi, type: "private_key_kv" },
  { re: /password\s*[:=]\s*['"]?[^'"\s]+/gi, type: "password" },
  { re: /mongodb(\+srv)?:\/\/[^\s]+/gi, type: "mongodb_uri" },
  { re: /postgres(?:ql)?:\/\/[^\s]+/gi, type: "postgres_uri" },
  { re: /cfr_[A-Za-z0-9_-]{20,}/g, type: "codeforge_refresh_token" },
  { re: /cfa_[A-Za-z0-9_-]{20,}/g, type: "codeforge_desktop_auth_code" },
  { re: /\b(?:sk|rk|pk)_(?:test|live)_[A-Za-z0-9]{8,}/g, type: "stripe_key" },
  { re: /\bwhsec_[A-Za-z0-9]{8,}/g, type: "stripe_webhook_secret" },
  { re: /\beyJ[A-Za-z0-9_-]{8,}\.[A-Za-z0-9_-]{8,}\.[A-Za-z0-9_-]{8,}/g, type: "jwt" },
  { re: /(?:__Host-|__Secure-)?codeforge-session=[^;\s]+/g, type: "session_cookie" },
  { re: /x-codeforge-control-token\s*[:=]\s*[^\s,;]+/gi, type: "control_plane_token" },
  { re: /\b(?:cookie|set-cookie)\s*[:=]\s*[^\n\r]+/gi, type: "cookie_header" },
  { re: /xox[baprs]-[A-Za-z0-9-]{10,}/g, type: "slack_token" },
  { re: /glpat-[A-Za-z0-9_-]{20,}/g, type: "gitlab_pat" },
  { re: /sk-ant-[A-Za-z0-9_-]{20,}/g, type: "anthropic_key" },
];
