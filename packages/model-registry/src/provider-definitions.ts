...
export const PROVIDER_DEFINITIONS: Record<string, ProviderDefinition> = {
  ...
  "ollama-cloud": {
    ...
    freeAccess: {
      class: "PROMOTIONAL_CREDIT",
      quota: "Free plan includes a monthly starter usage-credit amount for starter models and one concurrent cloud request; all cloud models publish non-zero token prices",
      spillover: "ACCOUNT_DEPENDENT",
      planDetection: "attestation",
      evidence: { source: "https://ollama.com/pricing", checkedAt: CHECKED, note: "Included starter usage is credit-funded. Purchased credits are consumed after included usage, so it is not a managed $0 route without a verified hard stop." },
    },
    privacy: { class: "strict", note: "Ollama's published Cloud privacy statement says prompts and responses are not logged or trained on; managed-intermediary terms remain unreviewed." },
    terms: { status: "LEGAL_REVIEW_REQUIRED", note: "Direct Cloud API exists, but its terms have not been cleared for a CodeForge-managed multi-user relay.", source: "https://ollama.com/terms" },
    policyMetadata: {
      commercial_packaging_eligible: false,
      user_policy_acceptance_required: false,
      region_restrictions: [],
      data_use_class: "STANDARD_PROVIDER_TERMS",
      confidential_data_eligible: false,
    ...
    docsUrl: "https://github.com/ollama/ollama/tree/main/docs/api",
  },
