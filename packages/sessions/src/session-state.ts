...
const TurnRecordStatusSchema = SessionStatusSchema.or(z.enum(["waiting_for_worker", "blocked"]));
...
export const WorkItemSchema = z.discriminatedUnion("kind", [
  ...
  z.object({
    ...
    correlation: z.object({
      ...
      codeForgeSessionId: z.string(),
      codeForgeTurnId: z.string(),
  ...
  z.object({
    kind: z.literal("agent_final_response"),
    id: z.string(),
    sessionId: z.string(),
    turnId: z.string(),
  ...
  z.object({
    kind: z.literal("desktop_worker_action"),
    id: z.string(),
    sessionId: z.string(),
    workflowId: z.string(),
    turnId: z.string(),
    ...
    resultExitCode: z.number().int().optional(),
    resultWorkspaceRevision: z.string().max(256).optional(),
    resultChangedResources: z.array(z.string().max(512)).max(256).optional(),
    createdAt: z.string().datetime(),
    updatedAt: z.string().datetime(),
  }),
  z.object({
    kind: z.literal("agent_continuation"),
    id: z.string(),
    sessionId: z.string(),
  ...
  z.object({
    kind: z.literal("hosted_workflow"),
    id: z.string(),
    sessionId: z.string(),
